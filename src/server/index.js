...
passport.use(new SteamStrategy({
    ...
    apiKey: '9F4A114B022707A2D36F230DA9704310'
},
...
app.get('/api/owned-games', async (req, res) => {
    ...
    let result = '';
    await axios.get(`https://api.steampowered.com/IPlayerService/GetOwnedGames/v0001/?key=9F4A114B022707A2D36F230DA9704310&steamid=${req.query.id}`)
